  ...
  return (
    <div className="bg-white rounded-lg p-3 shadow-md hover:shadow-lg transition-shadow duration-200">
      <div className="grid grid-cols-2 grid-rows-4 lg:grid-rows-1 lg:grid-cols-6 md:grid-cols-4 md:grid-rows-2 grid-flow-col gap-2 items-center">
        <div className="col-span-1 text-[#ff6a3d] font-semibold">#{idx + 1}</div>
        <div className="col-span-4">
          <a 
        ...
        <div className="col-span-1 flex items-center justify-end pr-4">
          <div className="text-[#1a2238] font-medium mr-2">{websiteUpvotes} Votes</div>
  ...
  return (
    <div className="min-h-screen bg-[#1a2238]">
      <div className="container mx-auto px-1 py-2">
        <h1 className="text-4xl font-bold text-[#ff6a3d] mb-4 mt-2">Welcome!</h1>
        
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
          {/* Sidebar */}
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-4 space-y-4">
              <p className="text-[#1a2238]">Here, you can add the link to any cool websites that you find and vote
                on websites that you like or don't like.</p>
